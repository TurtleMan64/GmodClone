...
out vec2 pass_textureCoordsLightmap;
...
void main(void)
{
	vec4 worldPosition = vec4(position, 1.0); //transformationMatrix * vec4(position, 1.0);
	...
	pass_textureCoordsLightmap = textureCoordsLightmap;
