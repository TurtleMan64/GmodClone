...
GuiTexture* GuiTextureResources::textureMap6        = nullptr;
GuiTexture* GuiTextureResources::textureMap7        = nullptr;
...
void GuiTextureResources::loadGuiTextures()
{
    ...
    INCR_NEW("GuiTexture"); textureMap1        = new GuiTexture(Loader::loadTexture("res/Images/Map1.jpg"),      0.500f, 0.50f,        1.778f, 1.000f, 4); textureMap1       ->alpha = 1.0f;
    INCR_NEW("GuiTexture"); textureMap2        = new GuiTexture(Loader::loadTexture("res/Images/Map2.jpg"),      0.500f, 0.50f,        1.778f, 1.000f, 4); textureMap2       ->alpha = 1.0f;
    INCR_NEW("GuiTexture"); textureMap4        = new GuiTexture(Loader::loadTexture("res/Images/Map4.jpg"),      0.500f, 0.50f,        1.778f, 1.000f, 4); textureMap4       ->alpha = 1.0f;
    INCR_NEW("GuiTexture"); textureMap5        = new GuiTexture(Loader::loadTexture("res/Images/Map5.jpg"),      0.500f, 0.50f,        1.778f, 1.000f, 4); textureMap5       ->alpha = 1.0f;
    INCR_NEW("GuiTexture"); textureMap6        = new GuiTexture(Loader::loadTexture("res/Images/Map6.jpg"),      0.500f, 0.50f,        1.778f, 1.000f, 4); textureMap6       ->alpha = 1.0f;
    INCR_NEW("GuiTexture"); textureMap7        = new GuiTexture(Loader::loadTexture("res/Images/Map7.jpg"),      0.500f, 0.50f,        1.778f, 1.000f, 4); textureMap7       ->alpha = 1.0f;
