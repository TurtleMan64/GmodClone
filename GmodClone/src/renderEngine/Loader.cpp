...
void Loader::addInstancedAttribute(GLuint vao, GLuint vbo, int attribute, int dataSize, int instancedDataLength, int offset)
{
    ...
    long long off = (long long)(4*offset);
    glVertexAttribPointer(attribute, dataSize, GL_FLOAT, false, instancedDataLength*4, (const void*)off); //might need to do something different here
